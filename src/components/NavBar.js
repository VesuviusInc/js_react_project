    ...
    return(
        <ul className="nav nav-tabs card-header-tabs">
          <li className="nav-item">
            {props.navBarState?<Link to={"/"} className="nav-link" href aria-current="true" id="contact-nav-bar">Kontakte</Link>:<Link to={"/"} className="nav-link active" href aria-current="true" id="contact-nav-bar">Kontakte</Link>}
          </li>
          <li className="nav-item">
